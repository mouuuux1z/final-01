...
export function DoctorPendingScreen({ navigation }: Props) {
  ...
  return (
    <View className="flex-1 items-center justify-center px-8">
      ...
      <Text className="mb-3 text-center text-2xl font-bold text-slate-900">{t('auth.doctorPendingTitle')}</Text>
      <Text className="mb-8 text-center text-base leading-6 text-slate-600">{t('auth.doctorPendingMessage')}</Text>
      <Button
